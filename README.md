...
# Área de interesse:
## Front End:
### VueJS, Angular, Bootstrap, Materialize, HTML5, CSS, jQuery, SASS;
### Transcrição arquivos PSD para HTML;
### Automatização. (Gulp, Grunt)
### Template Engines (mustache, ejs, pug, razor, twig);
...
### JET E-commerce
janeiro de 2018 – até o momento Ribeirão Preto e Região, Brasil


Área de atuação : Front-end, Tableless, HTML5, CSS, jQuery, VueJS, Cross-browser, Responsive design, Bootstrap, Materialize, Semantic UI.


Atendimento à agencias parceiras para criação de scripts e suporte sobre a plataforma Open Front;
...
Área de atuação : Front-end, Tableless, HTML5, CSS, jQuery, VueJS, Cross-browser, Responsive design, Bootstrap, Materialize.
